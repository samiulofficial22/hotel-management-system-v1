            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" name="password" class="form-control @error('password') is-invalid @enderror"
                        autocomplete="new-password" minlength="8" placeholder="{{ __('For office staff login') }}">
                    <small
                        class="text-muted">{{ __('Leave blank to create login later via Sync to Office Staff. Min 8 characters.') }}</small>
                ...
                <div class="mb-3">
                    <label class="form-label">{{ __('Profile photo') }} ({{ __('optional') }})</label>
                    <div class="d-flex align-items-center gap-3 mb-2">
                        <img id="profile-photo-preview" src="" alt="" class="rounded-circle border" width="60" height="60"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nid_number" class="form-control @error('nid_number') is-invalid @enderror"
                        value="{{ old('nid_number') }}" maxlength="50">
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <input type="text" name="employee_code"
                        class="form-control @error('employee_code') is-invalid @enderror" value="{{ old('employee_code') }}"
                        placeholder="{{ __('Auto-generated if left blank') }}" maxlength="30">
                ...
                <div class="mb-3">
                    ...
                    <select name="designation" class="form-select @error('designation') is-invalid @enderror">
                        ...
                        @foreach($roles ?? [] as $role)
                            <option value="{{ $role->name }}" {{ old('designation') === $role->name ? 'selected' : '' }}>
                                {{ $role->name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="mb-0">
                    ...
                    <select name="department_id" class="form-select @error('department_id') is-invalid @enderror">
                        ...
                        @foreach($departments ?? [] as $d)
                            <option value="{{ $d->id }}" {{ old('department_id') == $d->id ? 'selected' : '' }}>{{ $d->name }}
                                ({{ $d->code }})</option>
                        @endforeach
                    </select>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="employment_type"
                            ...
                            value="{{ old('employment_type') }}" placeholder="e.g. Full-time" maxlength="50">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" name="salary" class="form-control @error('salary') is-invalid @enderror"
                            value="{{ old('salary') }}" step="0.01" min="0" placeholder="0">
                ...
                <div class="mb-0">
                    ...
                    <input type="text" name="shift" class="form-control @error('shift') is-invalid @enderror"
                        value="{{ old('shift') }}" placeholder="e.g. Morning" maxlength="50">
