...
<div class="col-md-4"><div class="card"><div class="card-body"><h5>Revenue today</h5><p class="mb-0">{{ number_format($revenueToday ?? 0, 2) }}</p></div></div></div>
<div class="col-md-4"><div class="card"><div class="card-body"><h5>Revenue this month</h5><p class="mb-0">{{ number_format($revenueMonth ?? 0, 2) }}</p></div></div></div>
</div>
<h5>Alerts</h5>
