...
Route::middleware(['auth'])->group(function (): void {
    ...
    Route::prefix('guest')->name('guest.')->middleware('guest.portal')->group(function (): void {
        ...
        Route::middleware('permission:accounts.view')->group(function (): void {
            ...
            Route::get('/accounts/reports/profit-loss/pdf-preview', [AccountsController::class , 'reportProfitLossPdfPreview'])->name('accounts.reports.profit-loss.pdf-preview');
            ...
            Route::get('/accounts/reports/expense/pdf-preview', [AccountsController::class , 'reportExpensePdfPreview'])->name('accounts.reports.expense.pdf-preview');
            ...
            Route::get('/accounts/reports/daily-cash/pdf-preview', [AccountsController::class , 'reportDailyCashPdfPreview'])->name('accounts.reports.daily-cash.pdf-preview');
            ...
            Route::get('/accounts/reports/payroll-cost/pdf-preview', [AccountsController::class , 'reportPayrollCostPdfPreview'])->name('accounts.reports.payroll-cost.pdf-preview');
